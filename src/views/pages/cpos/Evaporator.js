...
function EvaporatorTable(props,index) {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      fetch("http://10.2.222.217/cposevaporator.json")
        .then(res => res.json())
  ...
  return (
      <div className="App" >
        ...
        <Card className="test">
          ...
          <DataTable title="Top 5 Approach Evaporator" columns={columns} data={data}  pagination paginationPerPage="5"  striped  defaultSortField="value" defaultSortAsc={false}  progressPending={pending} progressComponent={<CustomLoader />}  />
