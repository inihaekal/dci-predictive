...
function MotorTable(props,index) {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      fetch("http://10.2.222.129:9988/api/CPOS/all/category-object/average%20motor%20current")
        .then(res => res.json())
  ...
  return (
      <div className="App" >
        ...
        <Card className="test">
          ...
          <DataTable title="Top 5 Average Motor Current" columns={columns} data={data}  pagination paginationPerPage="5"  striped  defaultSortField="value" defaultSortAsc={false}  progressPending={pending} progressComponent={<CustomLoader />}  />
