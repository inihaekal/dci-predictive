...
class StatisticsCards extends React.Component {
  ...
  getCpos() {
    let url = `http://10.2.222.129:9988/api/CPOS/jk/3/category-chiller/2`;
    axios
      .get(url)
      .then(response => {
    ...
    return (
      <React.Fragment>
        ...
        <Row className="match-height">
          ...
          <Col xl="3" lg="3" sm="6">
            <StatisticsCard
              className={data_refrigerant.alert === "1" && data_status.value===1? 'thres-cpos' : '' }
              hideChart
              iconBg="primary"
              ...
              classone = {data_refrigerant.alert === "1" && data_status.value===1 ? ' color-white' : ''}

              classtwo ={data_refrigerant.alert === "1" && data_status.value===1 ? ' color-white' : ''}
            />
          </Col>

          <Col xl="2" lg="4" sm="6">
            <StatisticsCard
              className={data_afd.alert === "1" && data_status.value===1 ? 'thres-cpos' : '' }
              hideChart
              iconBg="primary"
              ...
              classone = {data_afd.alert === "1" && data_status.value===1 ? ' color-white' : ''}

              classtwo ={data_afd.alert === "1" && data_status.value===1 ? ' color-white' : ''}
            />
          </Col>
          <Col xl="2" lg="4" sm="6">
            <StatisticsCard
              className={data_motor.alert === "1" && data_status.value===1 ? 'thres-cpos' : '' }
              hideChart
              iconBg="primary"
              icon={<Zap className="primary" size={22} />}
              ...
              classone = {data_motor.alert === "1" && data_status.value===1 ? ' color-white' : ''}

              classtwo ={data_motor.alert === "1"  && data_status.value===1 ? ' color-white' : ''}
            />
          </Col>

          <Col xl="2" lg="4" sm="6">
            <StatisticsCard
              className={data_cwp.alert === "1" && data_status.value===1 ? 'thres-cpos' : '' }
              hideChart
              iconBg="primary"
              ...
              classone = {data_cwp.alert === "1" && data_status.value===1 ? ' color-white' : ''}

              classtwo ={data_cwp.alert === "1" && data_status.value===1 ? ' color-white' : ''}
            />
          </Col>
          ...
          <Col xl="3" lg="3" sm="6">
            <StatisticsCard
              className={data_temp_water_supply.alert === "1" && data_status.value===1 ? 'thres-cpos' : '' }
              hideChart
              iconRight
              iconBg="primary"
              ...
              classone = {data_temp_water_supply.alert === "1" && data_status.value===1 ? ' color-white' : ''}

              classtwo ={data_temp_water_supply.alert === "1" && data_status.value===1 ? ' color-white' : ''}
            />
          </Col>
          ...
          <Col xl="3" lg="3" sm="6">
            <StatisticsCard
              className={data_oiltank.alert === "1" && data_status.value===1 ? 'thres-cpos' : '' }
              hideChart
              iconRight
              iconBg="primary"
              icon={<Thermometer className="primary" size={22} />}
              ...
              classone = {data_oiltank.alert === "1" && data_status.value===1 ? ' color-white' : ''}

              classtwo ={data_oiltank.alert === "1" && data_status.value===1 ? ' color-white' : ''}
            />
          </Col>
          <Col xl="2" lg="2" sm="6">
            <StatisticsCard
              className={data_inboard.alert === "1" && data_status.value===1 ? 'thres-cpos' : '' }
              hideChart
              iconRight
              iconBg="primary"
              icon={<Thermometer className="primary" size={22} />}
              ...
              classone = {data_inboard.alert === "1" && data_status.value===1 ? ' color-white' : ''}

              classtwo ={data_inboard.alert === "1" && data_status.value===1 ? ' color-white' : ''}
            />
          </Col>
          <Col xl="2" lg="2" sm="6">
            <StatisticsCard
              className={data_outboard.alert === "1" && data_status.value===1 ? 'thres-cpos' : '' }
              hideChart
              iconRight
              iconBg="primary"
              icon={<Thermometer className="primary" size={22} />}
              ...
              classone = {data_outboard.alert === "1" && data_status.value===1 ? ' color-white' : ''}

              classtwo ={data_outboard.alert === "1" && data_status.value===1 ? ' color-white' : ''}
            />
          </Col>

          <Col xl="2" lg="2" sm="6">
            <StatisticsCard
              className={data_chwp.alert === "1"  && data_status.value===1 ? 'thres-cpos' : '' }
              hideChart
              iconRight
              iconBg="primary"
              icon={<Activity className="primary" size={22} />}
              ...
              classone = {data_chwp.alert === "1" && data_status.value===1 ? ' color-white' : ''}

              classtwo ={data_chwp.alert === "1" && data_status.value===1 ? ' color-white' : ''}
            />
          </Col>
          ...
          <Col xl="3" lg="6" sm="6">
            <StatisticsCard
              className={data_approach.alert === "1" && data_status.value===1 ? 'thres-cpos' : '' }
              hideChart
              iconRight
              iconBg="primary"
              icon={<Thermometer className="primary" size={22} />}
              ...
              classone = {data_approach.alert === "1" && data_status.value===1 ? ' color-white' : ''}

              classtwo ={data_approach.alert === "1" && data_status.value===1 ? ' color-white' : ''}
            />
          </Col>
          ...
          <Col xl="3" lg="6" sm="6">
            <StatisticsCard
              className={data_evaporator.alert === "1" && data_status.value===1 ? 'thres-cpos' : '' }
              hideChart
              iconRight
              iconBg="primary"
              icon={<Thermometer className="primary" size={22} />}
              ...
              classone = {data_evaporator.alert === "1" && data_status.value===1 ? ' color-white' : ''}

              classtwo ={data_evaporator.alert === "1"  && data_status.value===1 ? ' color-white' : ''}
            />
          </Col>
