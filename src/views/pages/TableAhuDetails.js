...
const components = {
  ...
  Differential_Pressure: React.lazy(() => import("./tabpages/AhuDiffTableTab")),
  Supply_Temperature: React.lazy(() => import("./tabpages/AhuTableTab"))
};
...
const TabDehum: React.FC = () => {
  ...
  const getRoute = (route: string) => `/ahu/${route}`;
      ...
      <TabContent activeTab={pathname}>
        <React.Suspense fallback={<h1>Loading...</h1>}>
          <Switch>
            ...
            <Redirect from="/ahu/Differential_Pressure" to="/ahu/Differential_Pressure" />
          </Switch>
        </React.Suspense>
      </TabContent>
    </>
